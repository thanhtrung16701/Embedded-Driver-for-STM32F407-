...
void USART_Init(USART_Handle_t *pUSARTHandle)
{
   ...
   {
      //Implement the code to EN the parity control
...
void USART_PeriControl(USART_RegDef_t *pUSARTx, uint8_t EnOrDi) // USART enable En or Di
{
   if(EnOrDi == ENABLE) // bit 13 CR1 -> USART peripheral enable(PE)
   {
